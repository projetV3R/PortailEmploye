...
<div class="flex flex-row h-lvh">
    ...
    <div class="absolute inset-0">
        <div class="w-full">
            <img src="{{ asset('images/Vector.png') }}" alt="" class="absolute h-screen lg:hidden">
        </div>
        <div class="w-full flex items-center h-screen">
            <img src="{{ asset('images/403_Error_Forbidden.gif') }}" alt="imageErreur403" class="absolute right-0  lg:hidden">
        </div>
    </div>
